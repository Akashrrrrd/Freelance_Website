    ...
    <div className="homepage">
      <div className="container">
        <h1 className="heading-text">
          Discover Freelance Services <br /> Effortlessly with{" "}
          <span>Oryve</span>
        </h1>
        ...
        <div className="companies">
          ...
          <div className="logo-container">
            ...
            <img src={netflix_logo} alt="Netflix" className="logo" />
            <img src={amazon_logo} alt="Amazon" className="logo" />
          </div>
        </div>
      </div>
